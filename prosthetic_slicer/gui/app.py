...
class MainWindow(QMainWindow):
    ...
    def _process_box(self):
        ...
        self.in_drain_auto = QCheckBox('Loch automatisch an die Gel-Mulde')
        self.in_drain_auto.setChecked(True)
    ...
    def _ui_to_cfg(self):
        ...
        c.process.drain_auto_position = self.in_drain_auto.isChecked()
    ...
    def _cfg_to_ui(self):
        ...
        self.in_drain_auto.setChecked(c.process.drain_auto_position)
